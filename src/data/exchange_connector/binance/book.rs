...
use crate::data::{
    exchange_connector::ExchangeSelector,
    shared::{
...
#[derive(Clone, PartialEq, PartialOrd, Debug, Deserialize, Eq, Default)]
...
impl ExchangeSelector for BinanceBook {
    type ExchangeConn = BinanceSpot;
}
