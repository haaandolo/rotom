...
#[derive(Debug)]
pub struct RestClient2<BaseUrl: AsRef<str> + Display + 'static, Parser, RequestBuilder> {
...
impl<BaseUrl: AsRef<str> + Display + 'static, Parser, RequestBuilder>
    RestClient2<BaseUrl, Parser, RequestBuilder>
where
    RequestBuilder: ExchangeRequestBuilder,
{
    pub fn new(base_url: BaseUrl, parser: Parser, request_builder: RequestBuilder) -> Self {
        Self {
