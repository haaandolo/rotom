...
use crate::{
    event_models::{event_book::OrderBookL2, event_trade::{AggTrades, Trades}}, exchange::{Connector, StreamSelector}, protocols::ws::WsMessage, shared::subscription_models::{ExchangeId, ExchangeSubscription}, transformer::{book::MultiBookTransformer, stateless_transformer::StatelessTransformer}
};
...
impl StreamSelector<BinanceSpot, OrderBookL2> for BinanceSpot {
    ...
    type StreamTransformer =
        MultiBookTransformer<BinanceSpot, BinanceSpotBookUpdater, OrderBookL2>;
}
