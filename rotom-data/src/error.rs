...
pub const ACCEPTABLE_DE_ERROR_MESSAGES: [&str; 7] = [
    ...
    "missing field `symbol` at line 1 column 19", // Ascendex custom ping response
    "missing field `symbol` at line 1 column 47", // Ascendex custom ping response
    "missing field `topic` at line 1 column 88", // Kucoin custom ping response
];
